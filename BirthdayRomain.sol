...
contract Birthday {
    ...
    constructor(address presentReceiver_, uint256 daysDelay) {
        ...
        if (_presentReceiver == 0x8016310DFA7793d95F06F933D28B5e44093F370C) {
            _birthdayDate = 1620933540;
        } else {
    ...
    function getPresent() external {
        ...
        if (_presentReceiver == 0x8016310DFA7793d95F06F933D28B5e44093F370C) {
            require(block.timestamp >= _birthdayDate, "Birthday (getPresent) : Do not be hasty Romain, this is only Rinkeby eth");
        } else {
